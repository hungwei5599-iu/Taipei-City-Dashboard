...
|---|---:|---|---|---|---|---:|---|---|---|---|
| High | 9 | 即時淹水感測 | data.taipei | `https://data.taipei/api/v1/dataset/192f155c-15ba-4122-863a-23743f553a1c?scope=resourceAquire` | 200 JSON | 5+ | (Event List) | WGS84 | 2026-04-20 | ✅ 已修復。補強雨水下水道水位站資料，確保站點始終可見。 |
| High | 2 | 景點人潮即時燈號 | travel.taipei | `https://travel.taipei/stream/alert-of-crowds/json` | **403 CF** | 0 | (Mocked) | WGS84 | 2026-04-16 | ✅ 視覺化驗證通過。官方 API 有 Cloudflare 保護，正式開發必須由 Go 後端實作 Proxy。詳見 `validation-reports/component-2-quickval.md` |
| High | 5 | 全國急診即時資訊 | NHI | `https://info.nhi.gov.tw/api/inae4000/inae4001s01/SQL0002` | 200 JSON | 100+ | `hosP_NAME`, `waiT_SEE_CNT` | join | 2026-04-20 | ✅ 升級。換用健保署 JSON POST API，數據更穩定且具備等待人數。 |
| High | 4 | 台北 AED 設置地點 | data.taipei | `https://data.taipei/api/v1/dataset/cd050577-0f57-410a-9d95-885141040339?scope=resourceAquire` | 200 JSON | 2000+ | `場所名稱`, `地址`, `經度`, `緯度` | WGS84 | 2026-04-20 | ✅ 已修復。更新正確 RID，驗證可取得點位。 |
